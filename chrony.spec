...
Source0  : https://download.tuxfamily.org/chrony/chrony-3.5.1.tar.gz
...
%prep
%setup -q -n chrony-3.5.1
cd %{_builddir}/chrony-3.5.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597954045
...
cp %{_builddir}/chrony-3.5.1/COPYING %{buildroot}/usr/share/package-licenses/chrony/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
