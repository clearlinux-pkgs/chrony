...
export LANG=C
export SOURCE_DATE_EPOCH=1559764389
...
cp COPYING %{buildroot}/usr/share/package-licenses/chrony/COPYING
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/chrony/COPYING
